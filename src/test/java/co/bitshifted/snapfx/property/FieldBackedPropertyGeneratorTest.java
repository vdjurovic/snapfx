...
public class FieldBackedPropertyGeneratorTest {
  ...
  void testStringBinding() {
    ...
    var stringBackedProperty =
        FieldBackedPropertyGenerator.stringFieldProperty(
            () -> foo.getStringValue(), value -> foo.setStringValue(value));
  ...
  void testIntBinding() {
    ...
    var intBackedProperty =
        FieldBackedPropertyGenerator.integerFieldProperty(
            () -> foo.getIntValue(), value -> foo.setIntValue(value));
  ...
  void testBooleanBinding() {
    ...
    var boolBackedProperty =
        FieldBackedPropertyGenerator.booleanFieldProperty(
            () -> foo.isBoolValue(), value -> foo.setBoolValue(value));
  ...
  void testDoubleBinding() {
    ...
    var doubleBackedProperty =
        FieldBackedPropertyGenerator.doubleFieldProperty(
            () -> foo.getDoubleValue(), value -> foo.setDoubleValue(value));
  ...
  void testFloatBinding() {
    ...
    var floatBackedProperty =
        FieldBackedPropertyGenerator.floatFieldProperty(
            () -> foo.getFloatValue(), value -> foo.setFloatValue(value));
  ...
  void testObjectBinding() {
    ...
    var objBackedProperty =
        FieldBackedPropertyGenerator.objectFieldProperty(
            () -> foo.getBarTest(), value -> foo.setBarTest(value));
  ...
  void testListBindings() {
    ...
    ObservableList<String> obSList =
        foo.getListValue() != null
            ? FXCollections.observableList(foo.getListValue())
            : FXCollections.observableArrayList();
    var listBackedProperty =
        FieldBackedPropertyGenerator.listFieldProperty(
  ...
  void testSetBindings() {
    ...
    ObservableSet<String> obsSet =
        foo.getSetValue() != null
            ? FXCollections.observableSet(foo.getSetValue())
            : FXCollections.emptyObservableSet();
    var setBackedProperty =
        FieldBackedPropertyGenerator.setFieldProperty(
  ...
  void testMapBindings() {
    ...
    ObservableMap<Integer, String> obsMap =
        foo.getMapValue() != null
            ? FXCollections.observableMap(foo.getMapValue())
            : FXCollections.emptyObservableMap();
    var mapBackedProperty =
        FieldBackedPropertyGenerator.mapFieldProperty(
